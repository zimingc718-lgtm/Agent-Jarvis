...
| 规模 | REQ 102 条 · TEST 171 条（主矩阵） · TASK 166 条 · tests/**/*.test.ts(x) 91 个 |
...
没有。102 条 REQ 全部在「测试矩阵」的「覆盖需求」列里至少出现过一次。
