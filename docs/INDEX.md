...
| 规模 | REQ 103 条 · TEST 172 条（主矩阵） · TASK 167 条 · tests/**/*.test.ts(x) 92 个 |
...
没有。103 条 REQ 全部在「测试矩阵」的「覆盖需求」列里至少出现过一次。
