...
|---|---|---|---|---|
| R1 需求评审 | 人工终止 | 产品 owner | 产品/架构/测试角色 Agent 出 ReAct 结构化意见 → 人拍板；CR 有「变化点登记」表 + R1 拍板痕迹 | `governance.py review r1` |
...
3. 需求确认后，生成或更新产品需求说明书，并在 CR 内建「变化点登记」表；角色 Agent 出意见 → **人拍板（R1）**。
