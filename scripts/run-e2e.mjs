...
const knowledgePath = join(process.cwd(), ".data", `e2e-knowledge-${stamp}`);
...
const result = spawnSync("npx playwright test", {
  ...
  env: {
    ...
    JARVIS_E2E_KNOWLEDGE_PATH: knowledgePath
  },
  shell: true
});
...
rmSync(knowledgePath, { recursive: true, force: true, maxRetries: 10, retryDelay: 200 });
