 ...
 * above all of these. `competitor-board` and `industry-spec-comparison` both follow the
 * same non-persisted reasoning as `board` (CR-20260918-competitor-board,
 * CR-20260918-industry-spec-comparison): a sticky comparison table would fight
 * `show_home`/`show_insight` across sessions the same way a sticky board would have.
 */
export type DisplayStage = "opening" | "board" | "competitor-board" | "industry-spec-comparison";
