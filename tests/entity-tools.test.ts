...
describe("entity tools", () => {
  ...
  const tools = () => {
    const [list, read, propose, proposeUpdate, addSourceTool, , extract] = createEntityTools({ root, knowledgeRoot });
    return { list, read, propose, proposeUpdate, addSourceTool, extract };
  };
